...
from app.operations import apply_changes, build_tag_stats, preview_add, preview_delete, preview_replace
...
class MainWindow(FramelessWindow):
    ...
    def _filter_by_tags(self, tags: list[str], mode: str) -> None:
    ...
    def _filter_summary(self) -> str:
        ...
        if self.state.filter_tags:
            ...
            parts.append(f"Labels {relation}: {shown}{suffix}" if self.language == "en" else f"标签{relation}：{shown}{suffix}")
        if self.language == "en":
