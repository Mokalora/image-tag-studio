...
class BatchPage(QFrame):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.operation_switch = ChoiceBar(["添加", "删除", "替换"])
    ...
    def _build_add_page(self) -> QWidget:
        ...
        grid.addWidget(self.add_input, 0, 1, 1, 2)
    ...
    def _build_delete_page(self) -> QWidget:
        ...
        grid.addWidget(self.delete_input, 0, 1, 1, 2)
        ...
        grid.addLayout(delete_action, 0, 3)
    ...
    def operation(self) -> str:
        return ["add", "delete", "replace"][self.stack.currentIndex()]
    ...
    def apply_language(self, language: str) -> None:
        ...
        if language == "en":
            ...
            self.operation_switch.set_labels(["Add", "Delete", "Replace"])
            ...
            self.delete_apply_button.setText("Delete to Buffer")
            ...
            self.operation_switch.set_labels(["添加", "删除", "替换"])
            ...
            self.delete_apply_button.setText("删除到暂存区")
